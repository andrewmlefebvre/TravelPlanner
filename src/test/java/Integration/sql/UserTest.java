...
public class UserTest {
    ...
    public void testCreateAndGetUser(){
        User user = new User(null, "Andrew", "Lefebvre", new Date(1999, 05, 03), "21 Test Ave Kingston RI 02882");
    ...
    public void testGetAllUsers(){
        User user1 = new User(null, "Test1", "Lefebvre", new Date(1999, 05, 03), "21 Test Ave Kingston RI 02882");
        User user2 = new User(null, "Test2", "Lefebvre", new Date(1999, 05, 03), "21 Test Ave Kingston RI 02882");
        User user3 = new User(null, "Test3", "Lefebvre", new Date(1999, 05, 03), "21 Test Ave Kingston RI 02882");
